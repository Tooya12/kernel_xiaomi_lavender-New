...
bot="8004365535:AAG8OiLHxTtD5Aj3kzoLF_Okb5VZRPCANe4"
chat_id="-1002601867400"
...
export KBUILD_BUILD_USER="ayzalme"
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 ayzalmeSkernel-lavender-${TANGGAL}.zip *
    cd ..
}
